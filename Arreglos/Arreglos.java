...
class Arreglos{
    ...
    do{
        ...
        System.out.println("Cual programa desea ejecutar");
        ...
        System.out.println("4.- Leer matriz a, para sumarla como. ");
        ...
        switch (opcion) {
            case 1: 
                ...
                do{
                    ...
                    np.neg();
                    System.out.println("Si quiere volver a inicializar el programa de nuevo escriba o.");
        ...
        System.out.println("Si desea volver al menu dale a la letra 0");
    ...
    public void neg(){
        ...
        Scanner entrada = new Scanner(System.in);
           ...
           System.out.println("Escriba el conjunto de numeros de sus arreglos ");
           for (i = 0; i < 10; i++) {
       ...
       public void pares(){
           ...
           System.out.println("Por favor llenar el array ");
           for (i = 0; i < 10; i++) {
